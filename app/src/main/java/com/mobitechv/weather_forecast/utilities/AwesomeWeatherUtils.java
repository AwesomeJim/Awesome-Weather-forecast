...
import com.mobitechv.weather_forecast.R;
 ...
 */
public class AwesomeWeatherUtils {
    private static final String LOG_TAG = AwesomeWeatherUtils.class.getSimpleName();
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if (!AwesomePreferences.isMetric(context)) {
